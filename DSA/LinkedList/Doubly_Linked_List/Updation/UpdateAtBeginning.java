// Doubly Linked List Implementation In Java And Update Element At Beginning Position
...
public class UpdateAtBeginning {
    ...
    public void updateFirstNode(int val){
        if(head==null){
    ...
    public static void main(String[] args) {
        UpdateAtBeginning list=new UpdateAtBeginning();
        ...
        list.display();
        System.out.print("Update value of beginning: ");
        int val=sc.nextInt();
        list.updateFirstNode(val);
