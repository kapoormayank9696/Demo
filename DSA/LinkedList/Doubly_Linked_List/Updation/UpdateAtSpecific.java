...
public class UpdateAtSpecific {
    ...
    public void updateSpecificNode(int index,int val){
        if(head==null){
    ...
    public static void main(String[] args) {
        UpdateAtSpecific list=new UpdateAtSpecific();
        ...
        list.display();
        System.out.print("Enter Position of update the node value: ");
        int index=sc.nextInt();
        System.out.print("Update value of End: ");
        int val=sc.nextInt();
        list.updateSpecificNode(index,val);
