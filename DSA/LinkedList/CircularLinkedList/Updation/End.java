// Update The Node From End Circular Linked List Algorithm Implementation In Java
...
public class End {
    ...
    // Function to update last node value from Circular Linked List
    public void updateAtEnd(int values) {
        if(head == null) {
