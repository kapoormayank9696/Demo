...
public class CountNodeOf_BST {
    ...
    public static int CountNodes (Node root) {
        ...
        // Recursive Function
        int leftheight=CountNodes(root.left); // Left Subtree
        int rightheight=CountNodes(root.right); // Right Subtree
    ...
    public static void main(String[] args) {
        ...
        print(root);
        System.out.println("\nCount number of Binary Search Tree(BST) Nodes: "+CountNodes(root));
    }
}
